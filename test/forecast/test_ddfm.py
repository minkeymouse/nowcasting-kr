"""Tests for DDFM forecasting functions."""
...
def test_forecast_ddfm_interface():
    """Test DDFM forecast function interface."""
...
@pytest.mark.skipif(not DDFM_AVAILABLE, reason=f"DDFM not available: {IMPORT_ERROR if not DDFM_AVAILABLE else ''}")
def test_run_recursive_forecast_ddfm_interface(sample_data):
    """Test DDFM recursive forecast function interface."""
...
@pytest.mark.skipif(not DDFM_AVAILABLE, reason=f"DDFM not available: {IMPORT_ERROR if not DDFM_AVAILABLE else ''}")
def test_run_multi_horizon_forecast_ddfm_interface(sample_data):

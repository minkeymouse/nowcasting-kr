...
def get_supabase_client(
    ...
    # Check multiple possible key variable names
    ...
    if not key:
        raise ValueError(
            "Supabase key must be provided or set in one of: "
            "SUPABASE_KEY, SUPABASE_SERVICE_ROLE_KEY, or SUPABASE_SECRET_KEY environment variable"
        )

...
#### 결론
F matrix inversion 자체는 문제가 아니며, Kalman filter의 forward/backward pass에서 수치적 오차가 누적되어 NaN/Inf가 전파되는 것이 근본 원인입니다. 이를 해결하려면:
1. Forward pass에서 V, Vu 업데이트 시 더 강한 안정화 필요
2. Backward pass에서 NaN/Inf 전파 방지 필요
3. sum_EZZ 계산 전에 EZZ의 NaN/Inf 제거 필요
